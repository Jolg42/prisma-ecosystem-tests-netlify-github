...
pnpm ts-node ../../utils/fetch-retry-and-confirm-version.ts --url https://$ID--gentle-jalebi-42db3f.netlify.app/.netlify/functions/index --prisma-version $(sh ../../utils/prisma_version.sh) --binary-string $files
